...
class Index extends React.Component {
  ...
  constructor(props) {
    ...
    this.roles = ['Developer', 'Tech Lover', 'Team Player', 'React.js', 'Full Stack Developer'];
  }
  ...
  render() {
    ...
    return (
      <BaseLayout className={`cover ${isFlipping ? 'cover-1' : 'cover-0'}`} {...this.props.auth}
                  headerType="index"
                  title="Constantine Kobylinskyi - Portfolio">
            ...
            <Row>
              ...
              <Col md="6" className="hero-welcome-wrapper">
                <div className="hero-welcome-text">
                  <h1>
                    Welcome to the portfolio website of Constantine Kobylinskyi.
